...
The same investigation can be done on PMDC motors. [TODO: not altogether true]
...
\sageplot[width=.75\textwidth]{j2ek_plot}
...
\sageplot[width=.75\textwidth]{j2ec_plot}
...
\sageplot[width=.75\textwidth]{j2eci_plot}
