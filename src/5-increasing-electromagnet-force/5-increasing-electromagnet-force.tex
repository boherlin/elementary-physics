...
Our reference coil will have $A_R = 1$ and we set $t = 5 A_L/A_R$ so our comparison function is:
...
\sageplot[width=.75\textwidth]{f2pc_plot}

It turns out that if time is fixed there is a maximum increase in force:
...
\sageplot[width=.75\textwidth]{f2pci_plot}

For $1/A_R = 24$ the force is about $4.5$ times greater and circa $90 \percent$ of the maximum, and for $1/A_R = 11$ the force is about $4$ times greater and circa $80 \percent$ of the maximum.
